...
message.channel.send(`${client.config.murphyTag2} <@${message.author.id}> kullanıcı adın **${isim}** olarak değiştirildi.`).setColor('0x800d0d').setAuthor(message.member.displayName, message.author.avatarURL({ dynamic: true })) 
