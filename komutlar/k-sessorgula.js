...
let embed = new Discord.MessageEmbed().setColor("010000").setFooter(`${client.config.footer}`).setTimestamp().setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true}))
...
message.channel.send(embed.setFooter(`${client.config.footer}`).setDescription(`
